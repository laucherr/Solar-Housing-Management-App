...
public class Clients extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel_Title.setBackground(new java.awt.Color(204, 0, 0));

        jLabel1.setFont(new java.awt.Font("Bookman Old Style", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Property Tenants");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jButton_Refresh, javax.swing.GroupLayout.PREFERRED_SIZE, 339, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(21, 21, 21))
        );
    ...
    private void jButton_Add_ClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Add_ClientActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Enter The Required Tenant Information [first name, last name, phone, address] ", "Add Tenant", 2);
        }
        else
        {
            if(client.addNewClient(new Prop_Client(0, fname, lname, phone, email, address)))
            {
               JOptionPane.showMessageDialog(null, "New Tenant Added To The System", "Add Client", 1);
            }
            else{
                JOptionPane.showMessageDialog(null, "Tenant NOT Added To The System", "Add Client", 2);
            }
        }
    ...
    private void jButton_Edit_ClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit_ClientActionPerformed
        ...
        try{
            ...
            if( fname.trim().equals("") || lname.trim().equals("") || phone.trim().equals("") || address.trim().equals("") )
            {
                JOptionPane.showMessageDialog(null, "Enter The Required Tenant Information [first name, last name, phone, address] ", "Edit Tenant", 2);
            }
            else
            {
                if(client.editClientData(new Prop_Client(clientId, fname, lname, phone, email, address)))
                {
                    JOptionPane.showMessageDialog(null, "Tenant Data Edited", "Edit Tenant", 1);
                }
                else{
                    JOptionPane.showMessageDialog(null, "Tenant Data NOT Edited", "Edit Tenant", 2);
                }
            }
        }catch(Exception ex)
        {
            JOptionPane.showMessageDialog(null, " Enter a Valid Tenant ID ", "Invalid Id", 0);
        }
    ...
    private void jButton_Remove_ClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Remove_ClientActionPerformed
        ...
        try{
            ...
            {
                JOptionPane.showMessageDialog(null, "Enter the Tenant ID", "Empty ID", 2);
            }
            else{

                // show a confirmation message before deleting the type
                int yes_or_no = JOptionPane.showConfirmDialog(null, "Do You Want To Delete This Tenant", "Delete Tenant", JOptionPane.YES_NO_OPTION);

                if(yes_or_no == JOptionPane.YES_OPTION)
                {
                    if(client.deleteClient(clientId))
                    {
                        JOptionPane.showMessageDialog(null, "Tenant Data Deleted", "Delete Tenant", 1);
                        ...
                        JOptionPane.showMessageDialog(null, "Operation Failed", "Delete Tenant", 2);
                    }
                }
        ...
        {
            JOptionPane.showMessageDialog(null, ex.getMessage()+ " Enter a Valid Tenant ID ", "Invalid Id", 0);
        }
