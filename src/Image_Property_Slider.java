 ...
 * @author laury
 */
public class Image_Property_Slider extends javax.swing.JFrame {

    /**
     * Creates new form Image_Property_Slider
     */
    ...
    public Image_Property_Slider(int pId) {
        initComponents();
        ...
        HashMap<byte[], Integer> map = new Prop_Property().propertyImagesList(propertyId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Image_Property_Slider.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Image_Property_Slider(propertyId).setVisible(true);
            }
        });
    }
